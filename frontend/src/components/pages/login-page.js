...
function LoginPage(props) {
    ...
    function openPopup(message) {
        setPopupSettings((prevValue) => ({ open: true, message: message }));
    }

    function closePopup() {
        setPopupSettings((prevValue) => ({ ...prevValue, open: false }));
    }
    ...
    return (
        <div className="login-page-container">
                    ...
                    {isOrganizer ? (
                        <>
                            <span className="dont-have-an-account-text">
                                ...
                                <span className="email-us-organizer-text">
                                    {" "}
                                    Email us
                                </span>
                            </span>
            ...
            {/* <CustomPopup settings={popupSettings} closePopup={closePopup} /> */}
        </div>
    );
}
